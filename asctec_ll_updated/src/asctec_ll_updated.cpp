...
#include <asctec_ll_updated/LLStatus.h>
#include <asctec_ll_updated/IMURawData.h>
#include <asctec_ll_updated/IMUCalcData.h>
#include <asctec_ll_updated/RCData.h>
#include <asctec_ll_updated/CTRLOut.h>
#include <asctec_ll_updated/GPSData.h>
#include <asctec_ll_updated/GPSDataAdvanced.h>
#include <asctec_ll_updated/SICmd.h>
...
asctec_ll_updated::LLStatus status_msg;
...
asctec_ll_updated::IMURawData imu_raw_data_msg;
...
asctec_ll_updated::IMUCalcData imu_calc_data_msg;
...
asctec_ll_updated::RCData rc_data_msg;
...
asctec_ll_updated::CTRLOut ctrl_out_msg;
...
asctec_ll_updated::GPSData gps_data_msg;
...
asctec_ll_updated::GPSDataAdvanced gps_data_advanced_msg;
...
void cmd_si_callback(const asctec_ll_updated::SICmd::ConstPtr& msg)
{
...
{
  ros::init(argc, argv, "asctec_ll_updated");
  ros::NodeHandle n("~");
